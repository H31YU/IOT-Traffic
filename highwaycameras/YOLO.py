...
def realTime(vid):
    ...
    while True:
        ...
        #cv2.line(img, (up_line_position,0), (up_line_position,ih), (0, 0, 255), 2)
        #cv2.line(img, (down_line_position,0), (down_line_position,ih), (0, 0, 255), 2)
...
def from_static_image(image):
    ...
    frequency = len(detected_classNames)
    print(frequency)
    #print(sum([frequency[i] for i in frequency.keys()]))
